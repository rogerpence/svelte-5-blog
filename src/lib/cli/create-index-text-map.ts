    ...
    acc['index_objects'].push(
        {
            ...
            content: removeMd(item.data.content),
...
//utes.writeObjectsToFile(sorted['index_objects'], outputFile, 'search_index')
utes.writeObjectsToFile(sorted['index_objects'], outputFile)